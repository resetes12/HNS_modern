...
static EWRAM_DATA u16 sOakIntroSpecies = 0;

static u16 GetOakIntroSpecies(void)
{
    static u16 species; 
    species = Random() % 4;
...
static void Task_NewGameBirchSpeech_Init(u8 taskId)
{
    ...
    FreeAllSpritePalettes();
    ResetAllPicSprites();
    sOakIntroSpecies = GetOakIntroSpecies();
...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, PALETTES_BG, sOakIntroSpecies, BALL_POKE);
...
{
    return CreateMonPicSprite_Affine(sOakIntroSpecies, Random32(), Random32(), MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}
